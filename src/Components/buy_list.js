...
export default class BuyList extends Component {
                    ...
                    return (
                        <Fragment>
                            {Cookies.get('loginSuccess')?
                                <Link to={`${config.baseUrl}trade/`+record.id} className="btn  btn-green megabutton">Buy</Link>
                            :
    ...
    async searchAmountFormSubmit(e) {
        ...
        data.trade_type = 2;
        // delete this.state.buyOrdersList
        console.log(data);
                    ...
                    <div className="col-lg-12 buy-sell">
                        <div className="package-tab-content">
                                ...
                                <form onSubmit={this.searchAmountFormSubmit}>
                                    <div className="row">
                                        <div className="col-sm-3 pt-4">
                                            ...
                                            <li role="presentation" className="buy active">
                                                <a href="#tab4" role="tab" data-toggle="tab" aria-selected="true" className="active" aria-expanded="false">I Want To BUY </a>
                                            </li>                                                
                                            <li role="presentation" className="sell">
                                                <a href={`${config.baseUrl}sell-list`} aria-selected="false" aria-expanded="true">I Want To SELL</a>
                                            </li>
                                            </ul>
                                        </div>
                                        <div className="col-sm-2">
                                            ...
                                            <div className="col-sm-3 text-right">
                                                ...
                                                <a href={`${config.baseUrl}buy-list`} > &nbsp;
                            ...
                            <div className="tab-content">
                                <div role="tabpanel" className="tab-pane fade active show" id="tab4">
                                <div className="row buy_coin"></div>
                                <br />
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="row">
                                                <div className="col-lg-12">
                                                    ...
                                                    <ReactDatatable
                                                        config={this.config}
                                                        records={this.state.buyOrdersList}
